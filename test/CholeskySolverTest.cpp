...
namespace spandex::test
{
	...
	{
		misc::CommonGraph<double> graph_10x10;
		misc::CommonGraph<double> graph_3x3;

	public:
		TEST_METHOD(Chol_1)
		{
			misc::CommonGraph<double> g(3);
			g.Insert(0, 0, 6);
			g.Insert(1, 0, 8);
			g.Insert(1, 1, 27);
			g.Insert(2, 0, 14);
